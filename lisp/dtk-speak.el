...
;;;$Id: dtk-speak.el,v 1.1 2002/01/20 18:57:07 inoue Exp $
;;; $Author: inoue $
  ...
  (let ((new-process nil)
    ...
    (cond
     (dtk-speak-server-initialized
      ...
      (when (and (not emacspeak-unibyte)
